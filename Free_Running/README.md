...
This example uses ADC in Free-Running mode. When configuring the ADC in Free-Running mode, the next conversion starts automatically after the previous one is completed. To reach the highest possible input impedance, the ADC input pin must have the digital input buffer and the pull-up resistor disabled.
...
- Pin PD6 as input, ADC input channel, and disable the digital input buffer and the pull-up resistor
- ADC configuration: Free-Running mode with 10-bit resolution, use the internal voltage reference and the peripheral clock divided by four as clock source
 ...
 3. Set the **Free_Running** project as Start-Up project. Right click the project in the **Solution Explorer** tab and click **Set as StartUp Project**.

<br><img src="../images/Start_Up_Project.PNG" height="500">

 4. Build the **Free_Running** project: Right click the **atmega4809-getting-started-with-adc-studio** solution and select **Build Solution**.
