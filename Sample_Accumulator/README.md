...
This example demonstrates how to use the sample accumulation function of the ADC to obtain results unaffected by the noise. The example accumulates 64 samples. The conversion result is represented by the accumulated value divided by 64.
...
- The ADC is configured in the following way:
  - Internal reference
  - Peripheral clock divided by four as clock source
  - 10 bit resolution
...
- Pin PD6 has input buffer and pull-up disabled
 ...
 3. Set the **Sample_Accumulator** project as Start-Up project. Right click the project in the **Solution Explorer** tab and click **Set as StartUp Project**.

<br><img src="../images/Start_Up_Project.PNG" height="500">

 4. Build the **Sample_Accumulator** project: Right click the **atmega4809-getting-started-with-adc-studio** solution and select **Build Solution**.
