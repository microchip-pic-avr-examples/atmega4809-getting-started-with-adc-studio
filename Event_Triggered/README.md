...
- Configure ADC as follows: 10-bit mode, use internal voltage reference, use the peripheral clock divided by 4 as clock source. Enable RESRDY interrupt as well as Event Trigger.
- Configure pin PB5 as output and with initial value HIGH. This pin will be used by LED and the initial value high represents LED OFF.
- RTC configured to overflow at 500 ms. RTC configured to use 32.768 kHz Oscillator with 32 prescaler.
...
- Event User: ADC Start Conversion
 ...
 3. Set the **Event_Triggered** project as Start-Up project. Right click on the project in the **Solution Explorer** tab and click **Set as StartUp Project**.

<br><img src="../images/Start_Up_Project.PNG" height="500">

 4. Build the **Event_Triggered** project: Right click on the **atmega4809-getting-started-with-adc-studio** solution and select **Build Solution**.
